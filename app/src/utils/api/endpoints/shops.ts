...
export const getShops = async (
  ...
  await instance.get<ShopListResponse>(
...
export const getShop = async (
  ...
  await instance.get<ShopResponse>(`${baseEndpoint.shops}/${id}`)

export const createShop = async (
  shopData: InsertShopQuery
): Promise<AxiosResponse<string>> =>
  await instance.post<string>(baseEndpoint.shops, { ...shopData })

export const patchShop = async (
  shopData: UpdateShopQuery
): Promise<AxiosResponse<string>> =>
  await instance.patch<string>(`${baseEndpoint.shops}/${shopData.id}`, {
    ...shopData.params
  })
